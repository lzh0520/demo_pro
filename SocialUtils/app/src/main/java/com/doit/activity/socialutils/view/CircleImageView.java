...
public class CircleImageView extends ImageView {
    ...
    public CircleImageView(Context paramContext, AttributeSet paramAttributeSet, int paramInt) {
        ...
        mBorderColor = a.getColor(R.styleable.ConstraintSet_layout_constraintCircle, mBorderColor);
        final int defalut = (int) (4 * paramContext.getResources().getDisplayMetrics().density + 1.5f);
        mBorderWidth = a.getDimensionPixelOffset(R.styleable.ConstraintSet_layout_constraintCircle, defalut);
        a.recycle();
    }
