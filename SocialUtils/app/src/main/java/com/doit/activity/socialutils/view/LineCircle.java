...
public class LineCircle extends View {
    ...
    //起止温度
    private int startTem = 19, stopTem = 24, currentTem = 10;
     ...
     * 设置当前温度
     */
    public void setCurrentTem(int tem) {
        this.currentTem = tem;
        invalidate();
    }
    ...
    private void drawCenterTem(Canvas canvas) {
        whitePaint.setTextSize(r * 0.35f);
        whitePaint.setTypeface(Typeface.DEFAULT);
        canvas.drawText(currentTem + "°", (centerX - r * 0.25f), (centerY + r * 0.08f), whitePaint);
    }
    ...
    private void drawStartTem(Canvas canvas) {
        whitePaint.setTextSize(r * 0.15f);
